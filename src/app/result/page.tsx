        ...
        <main className="mx-auto max-w-screen-xl">
          ...
          <div className="p-4 mb-4 border border-gray-200">
            ...
            <p className="text-gray-500">
              ...
              så det er noget på vores side. Denne tal påvirker ikke page grade.
            </p>
          ...
          <div className="p-4 mb-4 border border-gray-200">
            ...
            <p className="text-gray-500">
              F.eks hvis der er ingen video på siden, så bliver siden ikke
              valideret imod regler som omfatter video. Denne tal påvirker ikke
              page grade.
            </p>
